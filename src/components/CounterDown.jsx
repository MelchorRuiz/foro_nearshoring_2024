...
export function CounterDown({ i18n }) {
  ...
  return (
    <div className='text-white bg-transparent bg-opacity-50 backdrop-blur-md flex text-center justify-center gap-3 text-sm font-semibold py-5 px-5 border rounded-lg mt-10 w-full max-w-[500px]'>
      <div>

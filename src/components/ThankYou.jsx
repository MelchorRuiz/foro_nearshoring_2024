...
export function ThankYou({ i18n, homePath }) {
    ...
    return (
        <div className='w-full h-screen flex justify-center items-center flex-col gap-8 text-white'>
            <div>
                <h1 className='text-6xl font-jersey font-normal not-italic leading-none text-center text-amber-100 md:text-[4rem] lg:text-[5rem]'>{i18n.title}</h1>
                <div className='w-[20%] h-[3px] bg-amber-100 mx-auto mt-4 rounded-2xl md:w-[40%] lg:w-[60%]'></div>
            </div>
